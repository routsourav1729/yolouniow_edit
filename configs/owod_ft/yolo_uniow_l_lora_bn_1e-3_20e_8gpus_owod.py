_base_ = [('../../third_party/mmyolo/configs/yolov10/'
          'yolov10_l_syncbn_fast_8xb16-500e_coco.py'),
...
model = dict(
    ...
    freeze_prompt=False,
    embedding_path=f'embeddings/uniow-l/{_base_.owod_dataset.lower()}_t{_base_.owod_task}.npy',  # known embeddings
    unknown_embedding_path='embeddings/uniow-l/object.npy',  # unknown embeddings
    anchor_embedding_path='embeddings/uniow-l/object_tuned.npy',  # anchor embeddings
